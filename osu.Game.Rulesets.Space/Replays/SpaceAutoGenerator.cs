...
namespace osu.Game.Rulesets.Space.Replays
{
    public class SpaceAutoGenerator : AutoGenerator<SpaceReplayFrame>
    {
        ...
        protected override void GenerateFrames()
        {
            ...
            Frames.Add(
                new SpaceReplayFrame { Position = new Vector2(SpacePlayfield.BASE_SIZE / 2) }
            );
        ...
        private void moveToHitObject(SpaceHitObject h)
        {
            ...
            {
                Frames.Add(new SpaceReplayFrame { Time = t, Position = startPosition });
            }

            for (double t = moveStartTime; t < h.StartTime; t += frameInterval)
            {
                Vector2 pos = Interpolation.ValueAt(
                    t,
                    startPosition,
                    endPosition,
                    moveStartTime,
                ...
                Frames.Add(new SpaceReplayFrame { Time = t, Position = pos });
            }
        }
    }
}
