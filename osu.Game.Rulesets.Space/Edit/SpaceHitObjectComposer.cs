...
namespace osu.Game.Rulesets.Space.Edit
{
    ...
    public partial class SpaceHitObjectComposer : HitObjectComposer<SpaceHitObject>
    {
        ...
        {
            AddInternal(
                saveFilePickerOverlay = new SpaceSaveFilePickerScreen(
                    saveBeatmapToPath,
                    getDefaultSaveFileName,
                    false,
                    canDirectSaveToRealm,
                    requestDirectSaveToRealm
                )
            );
        ...
        protected override DrawableRuleset<SpaceHitObject> CreateDrawableRuleset(
            Ruleset ruleset,
            IBeatmap beatmap,
        ...
        public SpaceEditorPlayfield EditorPlayfield =>
            (SpaceEditorPlayfield)drawableRuleset.Playfield;
        ...
        private void requestDirectSaveToRealm()
        {
            ...
            if (dialogOverlay != null)
            {
                dialogOverlay.Push(
                    new ConfirmDialog(
                        "This feature is experimental. Use at your own risk. Continue?",
                        onConfirm
                    )
                );
                return;
